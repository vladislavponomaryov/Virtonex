...
gulp.task('vendor', () => {
	...
	return gulp.src(libs, { cwd: 'node_modules', base: './node_modules' }).pipe(gulp.dest(path.vendor))
})
...
gulp.task('clean', () => {
	return del([path.css, path.js + '/theme.min.js', path.vendor])
})
